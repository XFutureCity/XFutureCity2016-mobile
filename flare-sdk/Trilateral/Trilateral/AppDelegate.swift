...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate, FlareManagerDelegate, BeaconManagerDelegate /*, WCSessionDelegate */ {
    ...
    var host = "ec2-52-16-224-123.eu-west-1.compute.amazonaws.com"
    var port = 8080
    ...
    var flareManager = FlareManager(host: "ec2-52-16-224-123.eu-west-1.compute.amazonaws.com", port: 8080)
